...
class FilterDFTester(accel: => Accelerator)(implicit val p: config.Parameters) extends BasicTester with CacheParams {
  ...
  dutMem.r.bits := NastiReadDataChannel(0.U, mem((dutMem.ar.bits.addr >> size).asUInt() + rCnt.asUInt()), rDone)
  ...
  switch(memState) {
    ...
    is(sMemWrite) {
      ...
      when(dutMem.w.valid) {
        mem((dutMem.aw.bits.addr >> size).asUInt() + wCnt.asUInt()) := dutMem.w.bits.data
        printf("[write] mem[%x] <= %x\n", (dutMem.aw.bits.addr >> size).asUInt() + wCnt.asUInt(), dutMem.w.bits.data)
    ...
    is(sMemRead) {
      when(dutMem.r.ready) {
        printf("[read] mem[%x] => %x\n", (dutMem.ar.bits.addr >> size).asUInt() + rCnt.asUInt(), dutMem.r.bits.data)
      }
      when(rDone) {
  ...
  val testVec = Seq(
    ...
    Command(wrCmd, "h_C000_0008".U, "h_0000_0008".U, "h_F".U),           
    Command(wrCmd, "h_C000_000C".U, "h_0000_000C".U, "h_F".U),           
    Command(wrCmd, "h_C000_0010".U, "h_0000_0010".U, "h_F".U),           
    Command(wrCmd, "h_C000_0014".U, "h_0000_1014".U, "h_F".U),           
    Command(wrCmd, "h_C000_0018".U, "h_0000_1018".U, "h_F".U),           
    Command(wrCmd, "h_C000_001C".U, "h_0000_101C".U, "h_F".U),           
    Command(wrCmd, "h_C000_0020".U, "h_0000_2020".U, "h_F".U),           
    Command(wrCmd, "h_C000_0024".U, "h_0000_2024".U, "h_F".U),           
    Command(wrCmd, "h_C000_0028".U, "h_0000_2028".U, "h_F".U),          

    // Write pointers to filter kernel data
    Command(wrCmd, "h_C000_002C".U, "h_0000_4008".U, "h_F".U),           
    Command(wrCmd, "h_C000_0030".U, "h_0000_400C".U, "h_F".U),           
    Command(wrCmd, "h_C000_0034".U, "h_0000_4010".U, "h_F".U),           
    Command(wrCmd, "h_C000_0038".U, "h_0000_4014".U, "h_F".U),           
    Command(wrCmd, "h_C000_003C".U, "h_0000_4018".U, "h_F".U),           
    Command(wrCmd, "h_C000_0040".U, "h_0000_401C".U, "h_F".U),           
    Command(wrCmd, "h_C000_0044".U, "h_0000_4020".U, "h_F".U),           
    Command(wrCmd, "h_C000_0048".U, "h_0000_4024".U, "h_F".U),           
    Command(wrCmd, "h_C000_004C".U, "h_0000_402C".U, "h_F".U),

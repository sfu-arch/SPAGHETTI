...
(segShape: => L)(implicit p: Parameters)
  ...
  val indDMA_A =  Module(new inStreamDMA(bufSize = 512, memTensorType))
  val valDMA_A =  Module(new inStreamDMA(bufSize = 512, memTensorType))
  val ptrDMA_A =  Module(new inStreamDMA(bufSize = 512, memTensorType))

  val indDMA_B =  Module(new inStreamDMA(bufSize = 512, memTensorType))
  val valDMA_B =  Module(new inStreamDMA(bufSize = 512, memTensorType))
  val ptrDMA_B =  Module(new inStreamDMA(bufSize = 512, memTensorType))

...
class RowShapeTransformerIO[gen <: Shapes](memTensorType: String = "none")(wgtShape: => gen)(implicit val p: Parameters)
  extends Module {
...
class RowShapeTransformer[L <: Shapes](wgtTFDepth: Int, bufSize: Int, wgtTensorType: String = "none", memTensorType: String = "none")(wgtShape: => L)
                                         (implicit p: Parameters)
  extends RowShapeTransformerIO(wgtTensorType, memTensorType)(wgtShape)(p) {
